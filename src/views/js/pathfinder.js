...
class Connection {
    ...
    constructor(nodeIdA, nodeIdB, walkTime = -1) {
        var _a, _b;
        ...
        (_a = this.nodeA) === null || _a === void 0 ? void 0 : _a.addConnection(this);
        (_b = this.nodeB) === null || _b === void 0 ? void 0 : _b.addConnection(this);
...
function drawPathPeriodic() {
    ...
    modifyLine(currentLineID, currentNodeA.xPos, currentNodeA.yPos, lerp(currentNodeA.xPos, currentNodeB.xPos, currentLinePercent), lerp(currentNodeA.yPos, currentNodeB.yPos, currentLinePercent));
...
function drawLine(x1, y1, x2, y2) {
    ...
    lineHolder === null || lineHolder === void 0 ? void 0 : lineHolder.appendChild(newLine);
    return lineID;
}
function modifyLine(lineID, x1, y1, x2, y2) {
    ...
    const extendedX = x2 + (dx / length) * extensionAmount;
    const extendedY = y2 + (dy / length) * extensionAmount;
    line === null || line === void 0 ? void 0 : line.setAttribute("x1", x1.toString());
    line === null || line === void 0 ? void 0 : line.setAttribute("y1", y1.toString());
    line === null || line === void 0 ? void 0 : line.setAttribute("x2", extendedX.toString());
    line === null || line === void 0 ? void 0 : line.setAttribute("y2", extendedY.toString());
}
function drawCircle(x, y) {
    ...
    lineHolder === null || lineHolder === void 0 ? void 0 : lineHolder.appendChild(circle);
}
function lerp(start, end, amt) {
    return (1 - amt) * start + amt * end;
}
function uuidv4() {
    return "10000000-1000-4000-8000-100000000000".replace(/[018]/g, (c) => (parseInt(c) ^ crypto.getRandomValues(new Uint8Array(1))[0] & 15 >> parseInt(c) / 4).toString(16));
}
// #endregion
